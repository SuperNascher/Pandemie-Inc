...
class EventFactoryTests {
	...
	void testParseAiportClosedEvent() throws JsonProcessingException {
		...
		// Parse event
		AirportClosedEvent event = (AirportClosedEvent) this.eventFactory.parseFromJsonNode(rootNode);
		assertNotNull(event);
	...
	void testAntiVaccinationismEvent() throws JsonProcessingException {
		...
		// Parse event
		AntiVaccinationismEvent event = (AntiVaccinationismEvent) this.eventFactory.parseFromJsonNode(rootNode);
		assertNotNull(event);
	...
	void testBioTerrorismEvent() throws JsonProcessingException {
		String eventAsJson = "{\"type\": \"bioTerrorism\", " + 
	...
	void testCampaignLaunchedEvent() throws JsonProcessingException {
		String eventAsJson = "{\"type\": \"campaignLaunched\", " + 
							 " \"round\": 7}";
		JsonNode rootNode = this.objectMapper.readTree(eventAsJson);

		// Parse event
		CampaignLaunchedEvent event = (CampaignLaunchedEvent) this.eventFactory.
			parseFromJsonNode(rootNode);
		assertNotNull(event);
	...
	void testConnectionClosedEvent() throws JsonProcessingException {
		...
		String eventAsJson = "{\"city\": \"A\", \"sinceRound\": 8, \"type\": " +
							 "\"connectionClosed\", \"untilRound\": 9}";
		JsonNode rootNode = this.objectMapper.readTree(eventAsJson);

		// Parse event
		ConnectionClosedEvent event = (ConnectionClosedEvent) this.eventFactory.
			parseFromJsonNode(rootNode);
		assertNotNull(event);
	...
	void testEconomicCrisisEvent() throws JsonProcessingException {
		String eventAsJson = "{\"type\": \"economicCrisis\", " + 
							 " \"sinceRound\": 10}";
		JsonNode rootNode = this.objectMapper.readTree(eventAsJson);

		// Parse event
		EconomicCrisisEvent event = (EconomicCrisisEvent) this.eventFactory.
			parseFromJsonNode(rootNode);
		assertNotNull(event);
	...
	void testElectionsCalledEvent() throws JsonProcessingException {
		String eventAsJson = "{\"type\": \"electionsCalled\", " + 
							 " \"round\": 11}";
		JsonNode rootNode = this.objectMapper.readTree(eventAsJson);

		// Parse event
		ElectionsCalledEvent event = (ElectionsCalledEvent) this.eventFactory.
			parseFromJsonNode(rootNode);
		assertNotNull(event);
	...
	void testHygienicMeasuresAppliedEvent() throws JsonProcessingException {
		String eventAsJson = "{\"type\": \"hygienicMeasuresApplied\", " + 
							 " \"round\": 12}";
		JsonNode rootNode = this.objectMapper.readTree(eventAsJson);

		// Parse event
		HygienicMeasuresAppliedEvent event = (HygienicMeasuresAppliedEvent) this.eventFactory.
			parseFromJsonNode(rootNode);
		assertNotNull(event);
	...
	void testInfluenceExertedEvent() throws JsonProcessingException {
		String eventAsJson = "{\"type\": \"influenceExerted\", " + 
							 " \"round\": 13}";
		JsonNode rootNode = this.objectMapper.readTree(eventAsJson);

		// Parse event
		InfluenceExertedEvent event = (InfluenceExertedEvent) this.eventFactory.
			parseFromJsonNode(rootNode);
		assertNotNull(event);
	...
	void testLargeScalePanicEvent() throws JsonProcessingException {
		String eventAsJson = "{\"type\": \"largeScalePanic\", " + 
							 " \"sinceRound\": 14}";
		JsonNode rootNode = this.objectMapper.readTree(eventAsJson);

		// Parse event
		LargeScalePanicEvent event = (LargeScalePanicEvent) this.eventFactory.
			parseFromJsonNode(rootNode);
		assertNotNull(event);
	...
	void testMedicationAvailableEvent() throws JsonProcessingException {
		String eventAsJson = "{\"pathogen\": {\"duration\": \"-\", \"infectivity\": \"++\", " +
		...
		// Parse event
		MedicationAvailableEvent event = (MedicationAvailableEvent) this.eventFactory.
			parseFromJsonNode(rootNode);
		assertNotNull(event);
	...
	void testMedicationDeployedEvent() throws JsonProcessingException {
		...
		// Parse event
		MedicationDeployedEvent event = (MedicationDeployedEvent) this.eventFactory.
			parseFromJsonNode(rootNode);
		assertNotNull(event);
	...
	void testMedicationInDevelopmentEvent() throws JsonProcessingException {
		...
		// Parse event
		MedicationInDevelopmentEvent event = (MedicationInDevelopmentEvent) this.eventFactory.
			parseFromJsonNode(rootNode);
		assertNotNull(event);
	...
	void testOutbreakEvent() throws JsonProcessingException {
		...
		// Parse event
		OutbreakEvent event = (OutbreakEvent) this.eventFactory.
			parseFromJsonNode(rootNode);
		assertNotNull(event);
	...
	void testPathogenEncounteredEvent() throws JsonProcessingException {
		...
		// Parse event
		PathogenEncounteredEvent event = (PathogenEncounteredEvent) this.eventFactory.
			parseFromJsonNode(rootNode);
		assertNotNull(event);
	...
	void testQuarantineEvent() throws JsonProcessingException {
		String eventAsJson = "{\"sinceRound\": 21, " +
							 "\"type\": \"quarantine\", " + 
							 "\"untilRound\": 22}";
		JsonNode rootNode = this.objectMapper.readTree(eventAsJson);

		// Parse event
		QuarantineEvent event = (QuarantineEvent) this.eventFactory.
			parseFromJsonNode(rootNode);
		assertNotNull(event);
	...
	void testUprisingEvent() throws JsonProcessingException {
		String eventAsJson = "{\"participants\": 42, " +
							 "\"sinceRound\": 23, " +
							 "\"type\": \"uprising\"}"; 
		JsonNode rootNode = this.objectMapper.readTree(eventAsJson);

		// Parse event
		UprisingEvent event = (UprisingEvent) this.eventFactory.
			parseFromJsonNode(rootNode);
		assertNotNull(event);
	...
	void testVaccineAvailableEvent() throws JsonProcessingException {
		...
		// Parse event
		VaccineAvailableEvent event = (VaccineAvailableEvent) this.eventFactory.
			parseFromJsonNode(rootNode);
		assertNotNull(event);
	...
	void testVaccineDeployedEvent() throws JsonProcessingException {
		...
		// Parse event
		VaccineDeployedEvent event = (VaccineDeployedEvent) this.eventFactory.
			parseFromJsonNode(rootNode);
		assertNotNull(event);
	...
	void testVaccineInDevelopmentEvent() throws JsonProcessingException {
		...
		// Parse event
		VaccineInDevelopmentEvent event = (VaccineInDevelopmentEvent) this.eventFactory.
			parseFromJsonNode(rootNode);
		assertNotNull(event);
