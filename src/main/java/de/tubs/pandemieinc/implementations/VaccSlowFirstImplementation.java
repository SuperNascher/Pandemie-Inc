...
public class VaccSlowFirstImplementation implements PandemieImpl {

    final int quarantineRoundlength = 2; // ändern wenn fastestFirst

    public VaccSlowFirstImplementation() {}
    ...
    public String selectAction(Round round) {
        ...
        if (!singleCityPathogens.isEmpty()) {
            Pathogen deadlyPath = ActionHelper.findSlowlyPathogen(singleCityPathogens.values());
            City pathCity = null;
