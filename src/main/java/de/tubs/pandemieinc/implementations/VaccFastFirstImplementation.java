...
public class VaccFastFirstImplementation implements PandemieImpl {

    final int quarantineRoundlength1 = 1;
    final int quarantineRoundlength2 = 2;

    public VaccFastFirstImplementation() {}
    ...
    public String selectAction(Round round) {
        ...
        if (!singleCityPathogens.isEmpty()) {
            Pathogen fastPathogen = ActionHelper.findFastlyPathogen(singleCityPathogens.values());
            City pathCity = null;
