...
/**
 * ConnectionClosedEvent - A city event This event indicates that the connection from the given city
 * to the destination city can not be used as long this event exists.
 */
